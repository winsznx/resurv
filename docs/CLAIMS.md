...
| Every committed CI job passed on a clean GitHub runner | VERIFIED (two runs) | GitHub Actions runs [31642439279](https://github.com/winsznx/resurv/actions/runs/31642439279) (`f4a9578`) and [31653312589](https://github.com/winsznx/resurv/actions/runs/31653312589) (`d0f0e3a`), 2026-08-12 and 2026-08-13. All four jobs green in both: `format, lint, typecheck, test, build`; `forge fmt, build, test, invariant`; `no secrets in the tree, no permission bypass, no script drift`; `repository gate`. Two observations on clean runners, not a guarantee about future dependency or runner changes | 2026-08-13 | Engineering |
